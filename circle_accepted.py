...
package = Entity(model='package', color=color.rgb(127, 92, 214), position=(-6, -50, -20), scale=(6, 6, 6))
...
success_cube1 = Entity(model='cube', collider='mesh', color=color.rgb(5, 92, 2), position=(-6.5, -6.7, 10.5),
                       scale=0.99)
success = Entity(model='cube', collision='mesh', color=color.rgb(78, 217, 72), position=(-6.5, -60, -70))
