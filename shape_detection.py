    ...
    if key_flags['config']:
        ...
        for c in contours:
            ...
            if (xlen<56 and xlen>53 and ylen>53 and ylen<56):
                draw.add_text(frame0, f'Circle', x3 +10,  y2-40, center=True, color='green')
                draw.rect(frame0, x1, y1, x2, y2, weight=2, color='green')
                temp = 1


            elif(xlen<54 and xlen>49 and ylen>49 and ylen<54):
                draw.add_text(frame0, f'Triangle', x3 +10,  y2-40, center=True, color='green')
                draw.rect(frame0, x1, y1, x2, y2, weight=2, color='green')
                temp = 2
            elif (xlen<45 and xlen>39 and ylen>39 and ylen<45):
                draw.add_text(frame0, f'Square', x3 +10,  y2-40, center=True, color='green')
                draw.rect(frame0, x1, y1, x2, y2, weight=2, color='green')
                temp = 3
            else:
