...
cube2 = Entity(model='circle12', color=color.rgb(76, 76, 76), collider='mesh', position=(-6.35, -19.7, -17),
               scale=(.7, .7, .7))
cube4 = Entity(model='circle12', color=color.rgb(76, 76, 76), collider='mesh', position=(18, -22, 7),
               scale=(.7, .7, .7))
