...
cube = Entity(model='sq_bis', color=color.rgb(76, 76, 76), position=(-3, -9, -19))
cube2 = Entity(model='sq_bis', texture='cirrcle', collider='mesh', position=(-3.15, -19.7, -17), scale=(1, 1, 1))
package = Entity(model='package', color=color.rgb(27, 41, 245), position=(-3.1, -50, -20), scale=(6, 6, 6))
...
success_sphere = Entity(model='sphere', collider='mesh', color=color.rgb(1, 47, 120), position=(-6.3, -6.8, -2.9),
                        scale=1.49)
shape_1 = Entity(model='cube', collider='mesh', color=color.rgb(2, 94, 240), position=(-2.8, -20, -16), scale=1.1)
...
success_cube1 = Entity(model='cube', collider='mesh', color=color.rgb(5, 92, 2), position=(-6.5, -6.7, 10.5),
                       scale=0.99)
success = Entity(model='cube', collision='mesh', color=color.rgb(78, 217, 72), position=(-3, -60, -70))
